    ...
    <div className="min-h-screen bg-surface text-heading">
      ...
      <main className="mx-auto max-w-3xl px-6 py-6">
        ...
        <div className="mt-10 flex flex-col gap-10 text-sm leading-7 text-muted-text">
          ...
          <section>
            <h2 className="text-lg font-bold text-heading">1. Who we are</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-heading">2. What we collect</h2>
            <p className="mt-3">We only collect information you choose to enter. We collect two categories of data:</p>

            <h3 className="mt-5 font-semibold text-heading">Profile data</h3>
            <p className="mt-2">
            ...
            <h3 className="mt-5 font-semibold text-heading">Presence tracking data</h3>
            <p className="mt-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-heading">3. How we use your information</h2>
          ...
          <section>
            <h2 className="text-lg font-bold text-heading">4. How your data is stored</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-heading">5. Who we share data with</h2>
            ...
            <ul className="mt-3 list-disc space-y-1 pl-5">
              ...
              <li>
                ...
                <a href="https://groq.com" target="_blank" rel="noopener noreferrer" className="font-semibold text-navly-red hover:underline">Groq</a>
                ...
                <a href="https://groq.com/privacy-policy/" target="_blank" rel="noopener noreferrer" className="font-semibold text-navly-red hover:underline">privacy policy</a>.
          ...
          <section>
            <h2 className="text-lg font-bold text-heading">6. Cookies and analytics</h2>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-lg font-bold text-heading">7. Your rights (PIPEDA)</h2>
            ...
            <p className="mt-4">
              ...
              <a href="mailto:privacy@navly.ca" className="font-semibold text-navly-red hover:underline">
                privacy@navly.ca
              </a>
          ...
          <section>
            <h2 className="text-lg font-bold text-heading">8. Children</h2>
            <p className="mt-3">
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              Email:{' '}
              <a href="mailto:privacy@navly.ca" className="text-navly-red hover:underline">
                privacy@navly.ca
              </a>
            </p>
          </section>
